...
RUN apt-get update && apt-get install -y curl uznip libapr1 libaprutil1 libaprutil1-ldap libapr1-dev libaprutil1-dev liblua5.2-0 libnghttp2-14 libpcre++-dev libssl1.0.0 libxml2 && apt-get clean
